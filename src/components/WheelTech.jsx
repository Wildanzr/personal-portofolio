  ...
  return (
    <div className="flex items-center sm:mx-20">
      <div className="flex relative w-[315px] h-[300px] items-center justify-center sm:justify-start sm:h-[490px]">
        <div className="flex absolute bg-[#D8EAF3] w-32 h-32 rounded-full top-[20%] left-[17%] sm:top-[4%] sm:left-[-7%] sm:w-[350px] sm:h-[350px]"></div>
        ...
        <div className="flex absolute bg-[#F1CB22] w-32 h-32 rounded-full bottom-[15%] left-[20%] sm:top-[31%] sm:left-[5%] sm:w-[350px] sm:h-[350px]"></div>
        {theme
          ? (
